/*
SmartSoft
Componente: CDialogConfirmarCambiarRol
Fecha de creacion: 01/11/2022, Autorizó: Alejandra Patricia Chaparro Matias

Modificaciones:
    Fecha               Folio

Descripcion:
Permite cambiar el rol de moderador a consejero y de consejero a moderador
        ...
        <Mui.DialogContent>
          ...
          >
            <Mui.Typography variant="body1" component="p">
              {Variables.v_TEXTOS.confirmar_cambio}
            </Mui.Typography>
            <Mui.Grid
              container
              sx={{ width: "100%" }}
